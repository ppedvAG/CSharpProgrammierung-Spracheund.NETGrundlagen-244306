...
namespace Demo
{
    ...
    public class Auto : Fahrzeug
    {
        ...
        public Auto(): base() // Basis Konstruktor wird aufgerufen
        {
            AnzahlTüren = 0;
        }
        ...
        public Auto(string farbe, string treibstoff, int geschwindigkeit, int anzahlTüren) : base(farbe, treibstoff, geschwindigkeit) // Basis Konstruktor wird aufgerufen
        {
